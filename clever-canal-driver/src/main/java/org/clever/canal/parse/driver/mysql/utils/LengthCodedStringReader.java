...
@SuppressWarnings({"unused", "WeakerAccess", "UnusedAssignment"})
public class LengthCodedStringReader {
    ...
    public String readLengthCodedString(byte[] data) throws IOException {
        ...
        try {
            return new String(ArrayUtils.subarray(data, getIndex(), (int) (getIndex() + length)), encoding == null ? CODE_PAGE_1252 : encoding);
        } finally {
