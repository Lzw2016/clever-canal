...
import org.clever.canal.parse.driver.mysql.packets.client.AuthSwitchResponsePacket;
import org.clever.canal.parse.driver.mysql.packets.client.ClientAuthenticationPacket;
import org.clever.canal.parse.driver.mysql.packets.client.QuitCommandPacket;
import org.clever.canal.parse.driver.mysql.packets.server.*;
import org.clever.canal.parse.driver.mysql.socket.SocketChannel;
import org.clever.canal.parse.driver.mysql.socket.SocketChannelPool;
import org.clever.canal.parse.driver.mysql.utils.MSC;
import org.clever.canal.parse.driver.mysql.utils.MySQLPasswordEncrypter;
...
public class MysqlConnector {
    ...
    private void negotiate(SocketChannel channel) throws IOException {
        ...
        if (marker == -2 || marker == 1) {
            ...
            if ("mysql_native_password".equals(pluginName)) {
                try {
