...
import org.clever.canal.dbsync.binlog.LogContext;
import org.clever.canal.dbsync.binlog.LogEvent;
import org.clever.canal.dbsync.binlog.event.TableMapLogEvent.ColumnInfo;
import org.clever.canal.dbsync.binlog.exception.TableIdNotFoundException;
 ...
 */
@SuppressWarnings({"WeakerAccess", "SwitchStatementWithTooFewBranches", "AssertWithSideEffects", "unused"})
