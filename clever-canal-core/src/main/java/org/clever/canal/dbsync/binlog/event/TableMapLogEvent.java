 ...
 * <p>
 * Table_table_map_event_optional_metadata. Optional metadata fields follow
 ...
 * </table>
 */
@SuppressWarnings({"WeakerAccess", "unused", "FinalPrivateMethod", "DuplicateBranchesInSwitch", "DuplicatedCode"})
public final class TableMapLogEvent extends LogEvent {
     ...
     *
     * @since mysql-5.1.60/sql/rpl_utility.h
     */
