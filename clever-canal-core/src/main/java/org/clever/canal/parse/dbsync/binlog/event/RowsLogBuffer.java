...
import org.clever.canal.parse.dbsync.binlog.JsonConversion;
import org.clever.canal.parse.dbsync.binlog.JsonConversion.Json_Value;
import org.clever.canal.parse.dbsync.binlog.JsonDiffConversion;
...
public final class RowsLogBuffer {
     ...
     *
     * @since mysql-5.1.60/sql/log_event.cc -
     ...
     * Extracting next field value from packed buffer.
     *
     * @since mysql-5.1.60/sql/log_event.cc - log_event_print_value
     */
    ...
    final Serializable fetchValue(String columnName, int columnIndex, int type, final int meta, boolean isBinary) {
        ...
        switch (type) {
            ...
            case LogEvent.MYSQL_TYPE_SHORT: {
                ...
                // buffer.getInt16());
                value = (int) (short) buffer.getInt16();
