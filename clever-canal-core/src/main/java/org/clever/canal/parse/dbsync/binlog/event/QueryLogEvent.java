 ...
 *
 * @since mysql-5.1.6/sql/logevent.cc - Query_log_event
 */
@SuppressWarnings({"WeakerAccess", "FinalPrivateMethod", "unused", "FinalStaticMethod", "DuplicateBranchesInSwitch", "MismatchedReadAndWriteOfArray", "UnusedAssignment"})
                ...
                switch (code = buffer.getUint8()) {
                    ...
                    case Q_UPDATED_DB_NAMES:
                        ...
                        for (int i = 0; i < mtsAccessedDbs && buffer.position() < end; i++) {
                            ...
                            mtsAccessedDbNames[i] = buffer.getFixString(Math.min(length, NAME_LEN));
                        }
                        break;
                    ...
                    default:
                         ...
                         * order of code
                         */
                        logger.error("Query_log_event has unknown status vars (first has code: " + code + "), skipping the rest of them");
                        break; // Break loop
                }
            }
