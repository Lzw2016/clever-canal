...
//import org.clever.canal.protocol.CanalPacket.Ack;
//import org.clever.canal.protocol.CanalPacket.Compression;
...
//                switch (p.getType()) {
//                    case MESSAGES: {
//                        if (!p.getCompression().equals(Compression.NONE) && !p.getCompression().equals(Compression.COMPRESSION_TYPE_COMPATIBLE_PROTO2)) {
